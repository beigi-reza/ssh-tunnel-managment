...
در این روش یک اتصال امن بین دو سرور ار نوع SOCKS برقرار شده و کل ترافیک شبکه بالادستی به سرور پل منتقل شده ولی در اختیار کاربر نهایی قرار نمی گیرد.
...
اگر در سرور مقصد محدودیتی در باز کردن پورت ندارید می توانید یک پورت دیگر را نیز به این تونل تخصیص دهید. با فعال کردن این حالت پورت ssh تحت پایش داثم داخلی قرار گرفته 
